...
from deepsort.detector.YOLOv3.darknet import Darknet
from deepsort.detector.YOLOv3.yolo_utils import get_all_boxes, post_process, xyxy_to_xywh


class YOLOv3(object):
    def __init__(self, cfgfile, weightfile, namesfile, score_thresh=0.7, conf_thresh=0.01, nms_thresh=0.45, is_xywh=False):
        # net definition
    ...
    def __call__(self, ori_img):
        ...
        with torch.no_grad():
            ...
            boxes = get_all_boxes(out_boxes, self.conf_thresh, self.num_classes)  # batch size is 1
